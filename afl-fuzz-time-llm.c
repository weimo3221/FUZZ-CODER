...
#define SP20    SP10 SP10
  ...
  fprintf(fp_out,          "sync_id: %s \n"
          ...
          , total_crashes, total_tmouts, 
            ...
            stage_finds[STAGE_SPLICE], stage_cycles[STAGE_SPLICE], stage_cycles[STAGE_FLIP1] + stage_cycles[STAGE_FLIP2] + stage_cycles[STAGE_FLIP4] + stage_cycles[STAGE_FLIP8] + stage_cycles[STAGE_FLIP16] + stage_cycles[STAGE_FLIP32] + stage_cycles[STAGE_ARITH8] + stage_cycles[STAGE_ARITH16] + stage_cycles[STAGE_ARITH32] + stage_cycles[STAGE_INTEREST8] + stage_cycles[STAGE_INTEREST16] + stage_cycles[STAGE_INTEREST32]);
  if (stage_cycles[STAGE_FLIP1] + stage_cycles[STAGE_FLIP2] + stage_cycles[STAGE_FLIP4] + stage_cycles[STAGE_FLIP8] + stage_cycles[STAGE_FLIP16] + stage_cycles[STAGE_FLIP32] + stage_cycles[STAGE_ARITH8] + stage_cycles[STAGE_ARITH16] + stage_cycles[STAGE_ARITH32] + stage_cycles[STAGE_INTEREST8] + stage_cycles[STAGE_INTEREST16] + stage_cycles[STAGE_INTEREST32] >= 100000) {
    exit(0);
  }
